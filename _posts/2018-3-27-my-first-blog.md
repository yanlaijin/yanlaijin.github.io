...
```
显示如下：
![alt text]: https://github.com/yanlaijin/yanlaijin.github.io/blob/master/images/posts/zookeeper-start.png "zookeeper启动信息"
查看 zkServer.sh status 状态后显示如下：
![alt text]: https://github.com/yanlaijin/yanlaijin.github.io/blob/master/images/posts/zookeeper-status.png "zookeeper运行状态"
